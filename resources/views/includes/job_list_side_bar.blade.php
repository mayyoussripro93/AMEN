        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                <li>
                    ...
                    {{$jobTitle}} <span>
                        <?php
                        echo              DB::table('jobs')->where('title', 'like', $jobTitle)->where('is_active', '=', 1)->where('Initiatives_type', '=', 0)->where('expiry_date','>' ,\Carbon\Carbon::now())->count('id');
                        ?>
{{--                        {{App\Job::countNumJobs('title', $jobTitle)}}--}}
                    </span> </li>
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                <li>
                    ...
                    {{$state->state}} <span>
                         <?php
             echo           DB::table('jobs')->where('state_id', '=', $state->state_id)->where('is_active', '=', 1)->where('Initiatives_type', '=', 0)->where('expiry_date','>' ,\Carbon\Carbon::now())->count('id');
                        ?>
{{--                        {{App\Job::countNumJobs('state_id', $state->state_id)}}--}}
                    </span> </li>
                @endif
                @endforeach
                @endif
...
{{--                            @endphp--}}
                            <li>
                                ...
                                {{$city->city}} <span>
{{--                                    {{App\Job::countNumJobs('city_id', $city->city_id)}}--}}
                                    <?php
                                    echo           DB::table('jobs')->where('city_id', '=',$city->city_id)->where('is_active', '=', 1)->where('Initiatives_type', '=', 0)->where('expiry_date','>' ,\Carbon\Carbon::now())->count('id');
                                    ?>
                                </span> </li>
                        @endif
                    @endforeach
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                <li>
                    ...
                    {{$jobExperience->job_experience}} <span>
{{--                        {{App\Job::countNumJobs('job_experience_id', $jobExperience->job_experience_id)}}--}}
                        <?php
                        echo      DB::table('jobs')->where('job_experience_id', '=',$jobExperience->job_experience_id)->where('is_active', '=', 1)->where('Initiatives_type', '=', 0)->where('expiry_date','>' ,\Carbon\Carbon::now())->count('id');
                        ?>
                    </span> </li>
                @endif
                @endforeach
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                <li>
                    ...
                    {{$functionalArea->functional_area}} <span>
{{--                        {{App\Job::countNumJobs('functional_area_id', $functionalArea->functional_area_id)}}--}}
                        <?php
                        echo        DB::table('jobs')->where('functional_area_id', '=',$functionalArea->functional_area_id)->where('is_active', '=', 1)->where('Initiatives_type', '=', 0)->where('expiry_date','>' ,\Carbon\Carbon::now())->count('id');
                        ?>
                    </span>
                </li>
                @endif
        ...
        <!-- Top Companies -->
{{--        <div class="widget">--}}
{{--            <h4 class="widget-title">{{__('Jobs By Project')}}</h4>--}}
{{--            <ul class="optionlist view_more_ul">--}}
...
{{--            <span class="text text-primary view_more hide_vm">{{__('View More')}}</span> </div>--}}
        ...
        <div class="widget">
            ...
            <div class="form-group">
                {!! Form::number('salary_from', Request::get('salary_from', null), array('class'=>'form-control', 'id'=>'salary_from', 'placeholder'=>__('Salary from (SAR)'))) !!}
            </div>
            <div class="form-group">
                {!! Form::number('salary_to', Request::get('salary_to', null), array('class'=>'form-control', 'id'=>'salary_to', 'placeholder'=>__('Salary to (SAR)'))) !!}
            </div>
{{--            <div class="form-group">--}}
