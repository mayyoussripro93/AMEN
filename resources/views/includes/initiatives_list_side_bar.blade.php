        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                <li>
                    ...
                    {{$jobTitle}} <span>
                           <?php
                    echo    DB::table('jobs')->where('title', 'like', $jobTitle)->where('is_active', '=', 1)->where('Initiatives_type', '=', $Initiatives_type)->where('expiry_date','>' ,\Carbon\Carbon::now())->count('id');
                        ?>
{{--                        {{App\Job::countNumJobs('title', $jobTitle,$Initiatives_type)}}--}}
                    </span> </li>
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                <li>
                    ...
                    {{$state->state}} <span>
                           <?php
                        echo     DB::table('jobs')->where('state_id', '=', $state->state_id)->where('is_active', '=', 1)->where('Initiatives_type', '=', $Initiatives_type)->where('expiry_date','>',\Carbon\Carbon::now())->count('id');
                        ?>
{{--                        {{App\Job::countNumJobs('state_id', $state->state_id,$Initiatives_type)}}--}}
                    </span> </li>
                @endif
                @endforeach
                @endif
...
{{--                @endphp--}}
                <li>
                    ...
                    {{$city->city}} <span>
                          <?php
                        echo        DB::table('jobs')->where('city_id', '=',$city->city_id)->where('is_active', '=', 1)->where('Initiatives_type', '=', $Initiatives_type)->where('expiry_date','>' ,\Carbon\Carbon::now())->count('id');
                        ?>
{{--                        {{App\Job::countNumJobs('city_id', $city->city_id,$Initiatives_type)}}--}}
                    </span> </li>
                @endif
                @endforeach
                @endif
...
{{--            <span class="text text-primary view_more hide_vm">{{__('View More')}}</span> </div>--}}
        ...
        <!-- Date -->
{{--        <div class="widget">--}}
{{--            <h4 class="widget-title">{{__('Duration of the Initiative')}}</h4>--}}
{{--            <div class="form-group">--}}
{{--                {!! Form::text('duration_course', Request::get('duration_course', null), array('class'=>'form-control ', 'id'=>'duration_course', 'placeholder'=>__('Duration of the Initiative'))) !!}--}}
{{--            </div>--}}
...
{{--        </div>--}}
        ...
        <!-- Date -->
        <div class="widget">
            <h4 class="widget-title">{{__('Date Range')}}</h4>
            <div class="form-group">
{{--                {!! Form::select('date_type', ['' =>__('Select Date Type'),__('Hijri calendar'),__('Gregorian calendar')], Request::get('date_type', null), array('class'=>'form-control', 'id'=>'date_type')) !!}--}}
            </div>
                @if(Request::get('gregorian_data') !== null and Request::get('gregorian_data_to') !== null )

                <div class="form-group">
                {!! Form::text('gregorian_data', Request::get('gregorian_data', null), array('class'=>'form-control  ', 'id'=>'gregorian_data', 'placeholder'=>__('Date From'),'autocomplete'=>'off')) !!}
            </div>
            <div class="form-group">
                {!! Form::text('gregorian_data_to', Request::get('gregorian_data_to', null), array('class'=>'form-control  ', 'id'=>'gregorian_data_to', 'placeholder'=>__('Date to'),'autocomplete'=>'off')) !!}
            </div>
                @else
                    <div class="form-group">
                        {!! Form::text('gregorian_data', Request::get('gregorian_data', null), array('class'=>'form-control  ', 'id'=>'gregorian_data', 'placeholder'=>__('Date From'),'autocomplete'=>'off')) !!}
                ...
                @endif
{{--                @if(Request::get('islamic_data') !== null or Request::get('islamic_data_to') !== null  )--}}

{{--                <div class="form-group">--}}
{{--                {!! Form::text('islamic_data', Request::get('islamic_data', null), array('class'=>'form-control hidden_hijri', 'id'=>'islamic_data', 'placeholder'=>__('Date From'),'autocomplete'=>'off')) !!}--}}
{{--            </div>--}}
{{--            <div class="form-group">--}}
{{--                {!! Form::text('islamic_data_to', Request::get('islamic_data_to', null), array('class'=>'form-control  hidden_hijri', 'id'=>'islamic_data_to', 'placeholder'=>__('Date to'),'autocomplete'=>'off')) !!}--}}
{{--            </div>--}}
{{--                @else--}}
{{--                    <div class="form-group">--}}
{{--                        {!! Form::text('islamic_data', Request::get('islamic_data', null), array('class'=>'form-control hidden_hijri', 'id'=>'islamic_data', 'placeholder'=>__('Date From'), 'style'=>"display: none",'autocomplete'=>'off')) !!}--}}
{{--                    </div>--}}
{{--                    <div class="form-group">--}}
{{--                        {!! Form::text('islamic_data_to', Request::get('islamic_data_to', null), array('class'=>'form-control  hidden_hijri', 'id'=>'islamic_data_to', 'placeholder'=>__('Date to'), 'style'=>"display: none",'autocomplete'=>'off')) !!}--}}
{{--                    </div>--}}
{{--                @endif--}}
        </div>
            <!--Date end -->
...
{{--            <!-- Salary end --> --}}
            ...
            <!-- button -->
            <div class="searchnt">
                <button type="submit" class="btn" id="sub_1"><i class="fa fa-search" aria-hidden="true"></i> {{__('Search')}}</button>
            </div>
            <!-- button end-->
        </div>
        <!-- Side Bar end --> 
