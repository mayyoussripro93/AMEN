        ...
        <tr>
            ...
            <td class="content-wrapper" style="padding-left:24px;padding-right:24px"><br>
                ...
                <div class="title" style="font-family: 'Droid Arabic Kufi', serif; font-size: 18px;font-weight:400;color: #333;text-align: right;
                 padding-top: 20px; direction: rtl;">{{__('Welcome')}} {{ $data1['first_name'] }} ,
                </div>
            </td>
        </tr>
        <tr>
                        ...
                        <td class="row" valign="top"
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                                <tr style="text-align: right;">
                                    <td class="subtitle"
                                        style=" direction: rtl; text-align: right;font-family: 'Droid Arabic Kufi', serif;font-size:14px;line-height:22px;font-weight:400;color:#333;padding-bottom:30px; text-align: right;">
                                        <strong>{{__('Subject')}}: </strong>{{ $data['subject']  }}
                                        <br>
                                        <strong>{{__('Text Massage')}}: </strong>{{ $data1['message_txt'] }}
                                ...
                                <tr style="text-align: right;">
                                    <td class="subtitle"
                                        style=" direction: rtl; text-align: right;font-family: 'Droid Arabic Kufi', serif;font-size:14px;line-height:22px;font-weight:400;color:#333;padding-bottom:30px; text-align: right;">
                                        <strong class="green-color">{{__('You can respond to this email by replying to this email')}}</strong>
