...
{{--        <li class="heading">--}}
{{--            <h3 class="uppercase">{{__('Translation')}}</h3>--}}
{{--        </li>--}}
{{--        @include('admin/shared/side_bars/language')--}}
        ...
        <li class="heading">
            <h3 class="uppercase">{{__('States & Cities')}}</h3>
        </li>
...
{{--        @include('admin/shared/side_bars/country_detail')--}}
        ...
        @include('admin/shared/side_bars/city')
            ...
            <li class="heading">
                <h3 class="uppercase">{{__('Danger')}}</h3>
            </li>
            @include('admin/shared/side_bars/danger_cat')
            {{--            @include('admin/shared/side_bars/country_detail')--}}
            @include('admin/shared/side_bars/danger_sub_cat')
            {{--            @include('admin/shared/side_bars/city')--}}

{{--        <li class="heading">--}}
{{--            <h3 class="uppercase">{{__('User Packages')}}</h3>--}}
{{--        </li>--}}
{{--        @include('admin/shared/side_bars/package')--}}
        ...
        <li class="heading">
            <h3 class="uppercase">{{__('Job Attributes')}}</h3>
        </li>
...
{{--        @include('admin/shared/side_bars/salary_period') --}}
        ...
        <li class="heading">
            <h3 class="uppercase">{{__('Manage')}}</h3>
        </li>
