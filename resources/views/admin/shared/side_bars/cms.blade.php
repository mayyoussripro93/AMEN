<li class="nav-item  "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-file-text-o" aria-hidden="true"></i> <span class="title">{{__('C.M.S')}}</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
