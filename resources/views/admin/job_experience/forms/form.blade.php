...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_experience') !!}">
        {!! Form::label('job_experience', __('Job Experience'), ['class' => 'bold']) !!}
        {!! Form::text('job_experience', null, array('class'=>'form-control', 'id'=>'job_experience', 'placeholder'=>__('Job Experience'), 'dir'=>$direction)) !!}
