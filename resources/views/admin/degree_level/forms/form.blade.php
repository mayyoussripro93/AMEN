...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'lang') !!}" id="lang_div">
        ...
        {!! Form::select('lang', ['' => __('Select Language')]+$languages, $lang, ['class'=>'form-control', 'id'=>'lang', 'onchange'=>'setLang(this.value);']) !!}
        {!! APFrmErrHelp::showErrors($errors, 'lang') !!}                                       
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'degree_level') !!}">
        {!! Form::label('degree_level', __('Degree Level'), ['class' => 'bold']) !!}
        {!! Form::text('degree_level', null, array('class'=>'form-control', 'id'=>'degree_level', 'placeholder'=>__('Degree Level'), 'dir'=>$direction)) !!}
