...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'country') !!}">
        {!! Form::label('country', __('Danger Category'), ['class' => 'bold']) !!}
        {!! Form::text('country', null, array('class'=>'form-control', 'id'=>'country', 'placeholder'=>__('Danger Category'), 'dir'=>$direction)) !!}
