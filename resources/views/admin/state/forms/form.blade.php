...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'country_id') !!}" id="country_id_div">
        ...
        {!! Form::select('country_id', ['' => __('Select Country')]+$countries, old('country_id', (isset($state))? $state->country_id:$siteSetting->default_country_id), array('class'=>'form-control', 'id'=>'country_id', 'onchange'=>'filterDefaultStates(0);')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'country_id') !!}                                       
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'state') !!}">
        {!! Form::label('state', __('State'), ['class' => 'bold']) !!}
        {!! Form::text('state', null, array('class'=>'form-control', 'id'=>'state', 'placeholder'=>__('State'), 'dir'=>$direction)) !!}
        {!! APFrmErrHelp::showErrors($errors, 'state') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'latitude') !!}">
        {!! Form::label('state', 'latitude', ['class' => 'bold']) !!}
        {!! Form::text('latitude', null, array('class'=>'form-control', 'id'=>'latitude', 'placeholder'=>'latitude', 'dir'=>$direction)) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'longitude') !!}">
        ...
        {!! Form::text('longitude', null, array('class'=>'form-control', 'id'=>'longitude', 'placeholder'=>'longitude', 'dir'=>$direction)) !!}
