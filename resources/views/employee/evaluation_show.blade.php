                                ...
                                <div class="contentbox" style="overflow: auto;">
                                    <div class="portlet light portlet-fit portlet-datatable bordered" style="position:relative;">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <div class="user-info">
                                                    <h6 class="green-color am-sub-title"> {{__('Evaluation')}} ({{Auth::guard('employee')->user()->name}} / {{__(Auth::guard('employee')->user()->role->role_name)}})</h6>
                                                </div>
                                                ...
                                                <ul class="am-links pull-left">
                                                    ...
                                                    <li>
                                                        <form action="{{route('generate.pdf.evaluations')}}" method="post" id="pdf-form1" >
                                                            ...
                                                            <input type="hidden" value="" id="pdf-data" name="pdf-data-type">
                                                            @csrf
    ...
    <script type="text/javascript">
        ...
        $(function () {
            var oTable = $('#EvaluationDatatableAjax').DataTable({
                 ...
                 */
                ajax: {
                    url: '{!! route('fetch.data.staff.evaluation') !!}',
                    data: function (d) {
