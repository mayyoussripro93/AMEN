...
<div class="formrow">
    ...
    <input type="hidden" name="Educations_or_Training_or_Recruiting" value="Training" />
</div>
    ...
    <div class="col-md-6 col-xs-6">
        <div class="formrow  {!! APFrmErrHelp::hasError($errors, 'logo') !!}">
            <label class="btn btn-default">{{__('Upload Organizing Company Logo')}}
                <input type="file" name="logo" id="logo" style="display: none;"  value="{{old('logo')}}">
            </label>
...
{{--    <div class="formrow "> {!! Form::hidden('islamic_data', old('islamic_data'), array('class'=>'form-control', 'id'=>'islamic_data', 'placeholder'=>__('Islamic date'),'autocomplete'=>'off')) !!}--}}
{{--    </div>--}}
...
{{--    <div>--}}
{{--        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'gregorian_data') !!}">--}}
{{--            {!! Form::hidden('gregorian_data',  old('gregorian_data'), array('class'=>'form-control', 'id'=>'gregorian_data', 'placeholder'=>__('Initiative Gregorian Start Date').' *','autocomplete'=>'off')) !!}--}}
{{--            <span class="help-block">{!! APFrmErrHelp::showErrors($errors, 'gregorian_data') !!} </span>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--    <div class="col-md-6">--}}
...
{{--    </div>--}}
    <div class="col-md-6 col-xs-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'gregorian_data_to') !!}">
            ...
            <span class="help-block">{!! APFrmErrHelp::showErrors($errors, 'gregorian_data_to') !!} </span>
        </div>
    </div>
{{--    <div >--}}
...
{{--    </div>--}}
    ...
    <div>
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'duration_course') !!}" id="duration_course_div">
            ...
            <span class="help-block">{!! APFrmErrHelp::showErrors($errors, 'duration_course') !!} </span>
        </div>
    </div>
    <div class="col-md-6 col-xs-12">
