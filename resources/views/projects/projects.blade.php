...
@section('content')
    ...
    @include('includes.inner_page_title', ['page_title'=>__('Projects')])
                                ...
                                <div class="contentbox" style="overflow: auto;">
                                    <div class="portlet light portlet-fit portlet-datatable bordered" style="position:relative;">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <h6 class="green-color am-sub-title">{{__('Projects')}} ({{$project_count}})</h6>
                                                <ul class="am-links pull-left">
                                                    <li><a href="#" title="{{__('Print')}}"><i class="fa fa-print print_project" aria-hidden="true"></i></a></li>

                                                    <li><form action="{{route('generate.pdf.Projects')}}" method="post" id="pdf-form1" >
...
{{--                                                                <input type="text" class="form-control  datepicker" name="date_gregorian_txt" id="date_gregorian_txt" autocomplete="off" placeholder="{{__('Date')}}">--}}
                                                    ...
                                                    <div id="print_section" style="display: none;">
                                                        ...
                                                        <span class="am-label">{{__('Amen Projects')}}</span>
                                                        <table id="print_table" class="table table-hover table-striped print-projects"></table>
                                                    </div>
