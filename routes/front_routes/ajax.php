...
Route::post('filter-lang-Amenstates-dropdown', 'AjaxController@filterAmenStates')->name('filter.lang.statesAmen.dropdown');
Route::post('filter-degree-types-dropdown', 'AjaxController@filterDegreeTypes')->name('filter.degree.types.dropdown');

Route::post('filter-lang-cat-dropdown', 'AjaxController@filterLangCat')->name('filter.lang.cat.dropdown');
Route::post('filter-role-dropdown', 'AjaxController@filterRolesAdmin')->name('filter.role.dropdown');