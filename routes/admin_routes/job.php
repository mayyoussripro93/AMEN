...
Route::post('project-states', array_merge(['uses' => 'Admin\JobController@ProjectStates'], $all_users))->name('project.states');
Route::post('list-project-employee-dropdown', array_merge(['uses' => 'Admin\JobController@ProjectEmployeeDropdown'], $all_users))->name('filter.project.employee.dropdown');
/* * ****** End Job ********** */