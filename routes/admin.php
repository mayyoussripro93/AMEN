...
include_once($real_path . 'management_accounts.php');
include_once($real_path . 'project.php');
include_once($real_path . 'calender.php');
include_once($real_path . 'faq.php');
include_once($real_path . 'events.php');
include_once($real_path . 'seo.php');
include_once($real_path . 'cms.php');
include_once($real_path . 'home_media.php');
...
include_once($real_path . 'danger_cat.php');
include_once($real_path . 'danger_sub_cat.php');
