...
use App\Traits\FetchInitiatives;
...
class InitiativesController extends Controller
{
    ...
    {
        $this->middleware('auth', ['except' => ['InitiativesBySearch', 'InitiativesDetail']]);
    ...
    public function InitiativesBySearch(Request $request)
    {
        ...
        $city_ids =!is_array($request->query('city_id')) ? array_map('intval', explode(',', $request->query('city_id'))):"";
...
//        $islamic_date = $request->query('islamic_data','');
        $gregorian_data	 = $request->query('gregorian_data', '');
//        $islamic_date_to = $request->query('islamic_data_to','');
        $gregorian_data_to = $request->query('gregorian_data_to', '');
        $duration_course = $request->query('duration_course', '');
        $Initiatives_type =$request->query('Initiatives_type')?$request->query('Initiatives_type'):$request->query('{{urldecode($_GET[\'Initiatives_type\'])}}');

        $limit = 10;

        $jobs = $this->fetchJobs($search, $job_titles, $company_ids, $industry_ids, $job_skill_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $is_freelance, $career_level_ids, $job_type_ids, $job_shift_ids, $gender_ids, $degree_level_ids, $job_experience_ids, $salary_from, $salary_to, $salary_currency, $is_featured, $gregorian_data, $gregorian_data_to,$duration_course,$Initiatives_type, $order_by, $limit);

        /*         * ************************************************** */

        $jobTitlesArray = $this->fetchIdsArray($search, $job_titles, $company_ids, $industry_ids, $job_skill_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $is_freelance, $career_level_ids, $job_type_ids, $job_shift_ids, $gender_ids, $degree_level_ids, $job_experience_ids, $salary_from, $salary_to, $salary_currency, $is_featured ,$gregorian_data, $gregorian_data_to,$duration_course,$Initiatives_type, 'jobs.title');

        /*         * ************************************************* */

        $jobIdsArray = $this->fetchIdsArray($search, $job_titles,  $company_ids, $industry_ids, $job_skill_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $is_freelance, $career_level_ids, $job_type_ids, $job_shift_ids, $gender_ids, $degree_level_ids, $job_experience_ids, $salary_from, $salary_to, $salary_currency, $is_featured, $gregorian_data, $gregorian_data_to,$duration_course,$Initiatives_type, 'jobs.id');
        ...
        $countryIdsArray = $this->fetchIdsArray($search, $job_titles,  $company_ids, $industry_ids, $job_skill_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $is_freelance, $career_level_ids, $job_type_ids, $job_shift_ids, $gender_ids, $degree_level_ids, $job_experience_ids, $salary_from, $salary_to, $salary_currency, $is_featured,  $gregorian_data, $gregorian_data_to,$duration_course, $Initiatives_type, 'jobs.country_id');

        /*         * ************************************************** */

        $stateIdsArray = $this->fetchIdsArray($search, $job_titles,  $company_ids, $industry_ids, $job_skill_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $is_freelance, $career_level_ids, $job_type_ids, $job_shift_ids, $gender_ids, $degree_level_ids, $job_experience_ids, $salary_from, $salary_to, $salary_currency, $is_featured, $gregorian_data, $gregorian_data_to,$duration_course,$Initiatives_type,'jobs.state_id');

        /*         * ************************************************** */

        $cityIdsArray = $this->fetchIdsArray($search, $job_titles,  $company_ids, $industry_ids, $job_skill_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $is_freelance, $career_level_ids, $job_type_ids, $job_shift_ids, $gender_ids, $degree_level_ids, $job_experience_ids, $salary_from, $salary_to, $salary_currency, $is_featured,  $gregorian_data,  $gregorian_data_to,$duration_course,$Initiatives_type,'jobs.city_id');

        /*         * ************************************************** */

        $companyIdsArray = $this->fetchIdsArray($search, $job_titles,  $company_ids, $industry_ids, $job_skill_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $is_freelance, $career_level_ids, $job_type_ids, $job_shift_ids, $gender_ids, $degree_level_ids, $job_experience_ids, $salary_from, $salary_to, $salary_currency, $is_featured, $gregorian_data, $gregorian_data_to,$duration_course,$Initiatives_type,'jobs.company_id');
...
//      /  $industryIdsArray = $this->fetchIndustryIdsArray($companyIdsArray);
        ...
        $functionalAreaIdsArray = $this->fetchIdsArray($search, $job_titles,  $company_ids, $industry_ids, $job_skill_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $is_freelance, $career_level_ids, $job_type_ids, $job_shift_ids, $gender_ids, $degree_level_ids, $job_experience_ids, $salary_from, $salary_to, $salary_currency, $is_featured,  $gregorian_data, $gregorian_data_to,$duration_course,$Initiatives_type, 'jobs.functional_area_id');

        /*         * ************************************************** */

        $careerLevelIdsArray = $this->fetchIdsArray($search, $job_titles,  $company_ids, $industry_ids, $job_skill_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $is_freelance, $career_level_ids, $job_type_ids, $job_shift_ids, $gender_ids, $degree_level_ids, $job_experience_ids, $salary_from, $salary_to, $salary_currency, $is_featured,  $gregorian_data, $gregorian_data_to ,$duration_course,$Initiatives_type,'jobs.career_level_id');

        /*         * ************************************************** */

        $jobTypeIdsArray = $this->fetchIdsArray($search, $job_titles,  $company_ids, $industry_ids, $job_skill_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $is_freelance, $career_level_ids, $job_type_ids, $job_shift_ids, $gender_ids, $degree_level_ids, $job_experience_ids, $salary_from, $salary_to, $salary_currency, $is_featured,  $gregorian_data, $gregorian_data_to,$duration_course,$Initiatives_type, 'jobs.job_type_id');

        /*         * ************************************************** */

        $jobShiftIdsArray = $this->fetchIdsArray($search, $job_titles,  $company_ids, $industry_ids, $job_skill_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $is_freelance, $career_level_ids, $job_type_ids, $job_shift_ids, $gender_ids, $degree_level_ids, $job_experience_ids, $salary_from, $salary_to, $salary_currency, $is_featured,  $gregorian_data, $gregorian_data_to,$duration_course,$Initiatives_type,'jobs.job_shift_id');

        /*         * ************************************************** */

        $genderIdsArray = $this->fetchIdsArray($search, $job_titles,  $company_ids, $industry_ids, $job_skill_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $is_freelance, $career_level_ids, $job_type_ids, $job_shift_ids, $gender_ids, $degree_level_ids, $job_experience_ids, $salary_from, $salary_to, $salary_currency, $is_featured,  $gregorian_data,  $gregorian_data_to,$duration_course,$Initiatives_type, 'jobs.gender_id');

        /*         * ************************************************** */

        $degreeLevelIdsArray = $this->fetchIdsArray($search, $job_titles,  $company_ids, $industry_ids, $job_skill_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $is_freelance, $career_level_ids, $job_type_ids, $job_shift_ids, $gender_ids, $degree_level_ids, $job_experience_ids, $salary_from, $salary_to, $salary_currency, $is_featured, $gregorian_data,  $gregorian_data_to,$duration_course,$Initiatives_type,'jobs.degree_level_id');

        /*         * ************************************************** */

        $jobExperienceIdsArray = $this->fetchIdsArray($search, $job_titles,  $company_ids, $industry_ids, $job_skill_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $is_freelance, $career_level_ids, $job_type_ids, $job_shift_ids, $gender_ids, $degree_level_ids, $job_experience_ids, $salary_from, $salary_to, $salary_currency, $is_featured, $gregorian_data,  $gregorian_data_to,$duration_course,$Initiatives_type,'jobs.job_experience_id');
...
//            ->with('industryIdsArray', $industryIdsArray)
    ...
    public function InitiativesALLBySearch(Request $request)
    {
...
//            ->with('industryIdsArray', $industryIdsArray)
    ...
    public function InitiativesDetail(Request $request, $job_slug)
    {
...
//        $islamic_date_to = $request->query('islamic_data_to','');
        $gregorian_data_to = $request->query('gregorian_data_to', '');
        $duration_course = $request->query('duration_course', '');
        $Initiatives_type =$request->query('Initiatives_type')?$request->query('Initiatives_type'):$request->query('{{urldecode($_GET[\'u\'])}}');
        ...
        return view('Initiatives.detail')
                        ->with('job', $job)
