...
class ContactController extends Controller
{
    ...
    {
        $this->middleware('auth:employee', ['except' => ['reportAbuse','reportAbusePost','reportAbuseThanks']]);
    ...
    public function reportAbusePost(ReportAbuseFormRequest $request)
    {
        $data['your_name'] = $request->input('your_name');
        $data['your_email'] = $request->input('your_email');
        $data['subject'] = $request->input('subject');
    ...
    public function reportAbuseCompany()
    {

        return view('contact.report_abuse_company_page');
    }

    public function reportAbuseCompanyPost(Request $request)
    {
        $data['employee_id']=Auth::guard('employee')->user()->id;
        $data['your_name'] = Auth::guard('employee')->user()->name;
        $data['your_email'] = Auth::guard('employee')->user()->email;
