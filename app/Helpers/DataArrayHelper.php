...
class DataArrayHelper
{
    ...
    /*     * **************************** */
    public static function defaultDangerDangerSubCategoriesArray($country_id)
    {
        $array = DangerSubCategories::select('danger_sub_cat.state', 'danger_sub_cat.state_id')->where('danger_sub_cat.country_id', '=', $country_id)->isDefault()->active()->sorted()->pluck('danger_sub_cat.state', 'danger_sub_cat.state_id')->toArray();
        return $array;
    }

    /*     * **************************** */

    public static function langDangerDangerSubCategoriesArray($country_id)
    {
        $array = DangerSubCategories::select('danger_sub_cat.state', 'danger_sub_cat.state_id')->where('danger_sub_cat.country_id', '=', $country_id)->lang()->active()->sorted()->pluck('danger_sub_cat.state', 'danger_sub_cat.state_id')->toArray();
    ...
    public static function defaultDangerNationalitiesArray()
    {
        $array = DangerCategories::select('danger_cat.nationality', 'danger_cat.country_id')->isDefault()->active()->sorted()->pluck('countries.nationality', 'countries.country_id')->toArray();
        return $array;
    }

    public static function langDangerNationalitiesArray()
    {
        $array = DangerCategories::select('danger_cat.nationality', 'danger_cat.country_id')->lang()->active()->sorted()->pluck('countries.nationality', 'countries.country_id')->toArray();
        if ((int) count($array) === 0) {
    ...
    public static function defaultDangerCategoriesArray()
    {
        $array = DangerCategories::select('danger_cat.country', 'danger_cat.country_id')->isDefault()->active()->sorted()->pluck('countries.country', 'countries.country_id')->toArray();
        return $array;
    }

    public static function langDangerCategoriesArray()
    {
        $array = DangerCategories::select('danger_cat.country', 'danger_cat.country_id')->lang()->active()->sorted()->pluck('countries.country', 'countries.country_id')->toArray();
        if ((int) count($array) === 0) {
            $array = self::defaultDangerCategoriesArray();
        }
        return $array;
    }
    ...
    /*     * **************************** */
    public static function defaultSubCategoryArray($country_id)
    {
      $array = DangerSubCategories::select('danger_sub_cat.state', 'danger_sub_cat.id')->where('danger_sub_cat.country_id', '=', $country_id)->isDefault()->active()->sorted()->pluck('danger_sub_cat.state', 'danger_sub_cat.id')->toArray();
    ...
    public static function langSubCategoryArray($country_id)
    {
        $array = DangerSubCategories::select('danger_sub_cat.state', 'danger_sub_cat.id')->where('danger_sub_cat.country_id', '=', $country_id)->lang()->active()->pluck('danger_sub_cat.state', 'danger_sub_cat.id')->toArray();
        //$array = DangerSubCategories::select('danger_sub_cat.state', 'danger_sub_cat.state_id')->where('danger_sub_cat.country_id', '=', $country_id)->lang()->active()->toSql();
        //dd($array);
        if ((int) count($array) === 0) {
            $array = self::defaultSubCategoryArray($country_id);
        }
    ...
    {
        $array = Country::select('countries.country', 'countries.country_id')->isDefault()->active()->sorted()->where('countries.country_id','=',191)->pluck('countries.country', 'countries.country_id')->toArray();
        return $array;
    }

    public static function langCountriesArray()
    {
        $array = Country::select('countries.country', 'countries.country_id')->lang()->active()->sorted()->where('countries.country_id','=',191)->pluck('countries.country', 'countries.country_id')->toArray();
        if ((int) count($array) === 0) {
